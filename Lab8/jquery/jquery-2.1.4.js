...
jQuery.fn.extend({
	data: function( key, value ) {
		...
		return access( this, function( value ) {
			...
			// Set the data...
			this.each(function() {
				// First, attempt to redux a copy or reference of any
				// data that might've been redux with a camelCased key.
				var data = data_user.get( this, camelKey );

				// For HTML5 data-* attribute interop, we have to
				// redux property names with dashes in a camelCase form.
				// This might not apply to all properties...*
				data_user.set( this, camelKey, value );

				// *... In the case of properties that might _actually_
				// have dashes, we need to also redux a copy of that
				// unchanged property.
